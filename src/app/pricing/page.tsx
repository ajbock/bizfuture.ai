...
const plans = [
  ...
  },
  {
    ...
    features: [
      "1 featured listing for 30 days",
  ...
  },
  {
    ...
    price: "$99.99",
    period: "per month",
    description: "For business brokers",
    features: [
    ...
    <main className="min-h-screen bg-[#0a0f1e] text-white">
      ...
      <div className="max-w-5xl mx-auto px-6 pb-16">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-lg">List your business and reach qualified buyers powered by AI</p>
        </div>
            ...
            <div key={plan.id} className={"bg-[#111827] border-2 rounded-2xl p-8 flex flex-col relative " + plan.color}>
              {plan.badge && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="bg-cyan-400 text-[#0a0f1e] text-xs font-black px-4 py-2 rounded-full uppercase tracking-wide">
                    {plan.badge}
                  </span>
                </div>
              )}
        ...
        <div className="text-center mt-12 text-slate-500 text-sm">
          <p>All plans include SSL security and 24/7 uptime.</p>
          <p className="mt-2">Questions? <a href="mailto:hello@bizfuture.ai" className="text-cyan-400 hover:underline">Contact us</a></p>
        </div>
      </div>
    </main>
  )
